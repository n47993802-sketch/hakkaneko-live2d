(function () {
  ...
  function buildCard(a) {
    ...
    return (
      ...
      avatar +
      '" ' +
      'class="w-24 h-24 rounded-full border-2 border-white/10 mb-4 object-cover group-hover:scale-105 transition-transform shadow-lg img-fade" alt="' +
      name +
      '" ' +
  ...
  function renderArtists() {
    ...
    if (!list) {
      console.error(
        "[artists-render] window.ARTISTS_CONFIG 尚未定義，請確認 artists-config.js 有在 artists-render.js 之前載入",
      );
      return;
    }
