...
(function() {
    ...
    window.I18N['ja'] = {
            ...
            nav_creative: 'クリエイティブ', nav_portfolio: 'ポートフォリオ-repair',
            nav_channels: 'おすすめチャンネル', nav_fanart: 'ファンアート-repair',
            ...
            demo_input_hint_title: '「モデルを読み込む」をクリックしてインタラクションを開始', demo_input_hint_desc: 'マウスを動かすとキャラクターの視線が自動で追従します',
