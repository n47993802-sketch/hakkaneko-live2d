...
(function() {
    ...
    window.I18N['zh-TW'] = {
            ...
            tmpl_card_kanso_name: '換裝娃娃（殘光）', tmpl_card_kanso_desc: '共用骨架換裝模板，已完成 Live2D 動態工程，直接套用衣裝貼圖即可使用。', tmpl_card_kanso_price: 'NT$ 1,000 起', tmpl_card_more_soon: '即將公開',
            ...
            tmpl_copy_acc: '配件需求', tmpl_copy_supp: '補充說明', tmpl_gallery_switch: '點擊切換服裝',
            tmpl_s1_title: '選擇模板衣裝', tmpl_s1_hint: '（第一套底價，後續每套 +$400）', tmpl_outfit_price_1: '第 1 套 NT$ 1,000', tmpl_outfit_price_add: '第 2 套起每套 +NT$ 400', tmpl_custom_price: 'NT$ 1,500 起', tmpl_custom_note: '需與繪師、建模師詳細溝通',
